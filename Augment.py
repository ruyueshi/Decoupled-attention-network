...
def GenerateDistort(src, segment):
    return distort(src, segment)


def GenerateStretch(src, segment):
    return stretch(src, segment)


def GeneratePerspective(src, segment):
    return perspective(src, segment)
