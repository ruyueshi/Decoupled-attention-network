...
class LineGenerate():
    def __init__(self, IAMPath, img_max_num, conH, conW, augment=False, training=False):
...
class WordGenerate():
    def __init__(self, IAMPath, img_max_num, conH, conW, augment=False):
        self.augment = augment
        self.conH = conH
        self.conW = conW
        standard = []
...
class IAMDataset(Dataset):
    def __init__(self, img_list, img_max_num, img_height, img_width, transform=None):
        IAMPath = img_list
        self.conH = img_height
        self.conW = img_width
        self.LG = LineGenerate(IAMPath, img_max_num, self.conH, self.conW)
...
class IAMSynthesisDataset(Dataset):
    def __init__(self, img_list, img_max_num, img_height, img_width, augment=False, transform=None):
        self.training = True
        self.augment = augment
        IAMPath = img_list
        self.conH = img_height
        self.conW = img_width
        self.LG = LineGenerate(IAMPath, img_max_num, self.conH, self.conW, self.augment, self.training)
        self.WG = WordGenerate(IAMPath, img_max_num, self.conH, self.conW, self.augment)
